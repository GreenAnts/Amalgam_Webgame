...
| Link | Details |
| -------- | --------- |
| [Join Our Forums](https://unfinishedprojects.flarum.cloud) | We were previously using Discord, but we are switching to a community forum (which also includes messaging). If you’d like to playtest, ask questions, discuss strategy, or contribute, please head over to our community forums. |
